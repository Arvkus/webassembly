...
(function() {
 var loadPackage = function(metadata) {
    ...
    var PACKAGE_NAME = 'module.data';
    var REMOTE_PACKAGE_BASE = 'module.data';
...
Module['FS_createPath']('/filesystem', 'models', true, true);
Module['FS_createPath']('/filesystem', 'shaders', true, true);
        ...
        DataRequest.prototype.byteArray = byteArray;
          ...
          for (var i = 0; i < files.length; ++i) {
            DataRequest.prototype.requests[files[i].filename].onload();
              ...
              Module['removeRunDependency']('datafile_module.data');

    };
    Module['addRunDependency']('datafile_module.data');
 ...
 loadPackage({"files": [{"start": 0, "audio": 0, "end": 274500, "filename": "/filesystem/models/model2.obj"}, {"start": 274500, "audio": 0, "end": 7611786, "filename": "/filesystem/models/model6.obj"}, {"start": 7611786, "audio": 0, "end": 9724537, "filename": "/filesystem/models/model3.obj"}, {"start": 9724537, "audio": 0, "end": 9725708, "filename": "/filesystem/models/model1.obj"}, {"start": 9725708, "audio": 0, "end": 9926366, "filename": "/filesystem/models/model4.obj"}, {"start": 9926366, "audio": 0, "end": 12560740, "filename": "/filesystem/models/model5.obj"}, {"start": 12560740, "audio": 0, "end": 12561659, "filename": "/filesystem/shaders/fragment.glsl"}, {"start": 12561659, "audio": 0, "end": 12562168, "filename": "/filesystem/shaders/vertex.glsl"}], "remote_package_size": 12562168, "package_uuid": "3c261ef7-3c14-4bab-936e-6270272244ac"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 5458336,
    DYNAMIC_BASE = 5458336,
    DYNAMICTOP_PTR = 215424;
...
function _display_fps(f){ document.querySelector("#span_fps").innerHTML = "Kadrai: " + f; }
function _main_ready(){ let elem = document.querySelector("#loading_sceen"); elem.parentNode.removeChild(elem); }
function _model_complexity(tris){ document.querySelector("#span_tris").innerHTML = "Trikapiai: " + tris / 3; }



// STATICTOP = STATIC_BASE + 214432;
...
var asmLibraryArg = {
  ...
  "_main_ready": _main_ready,
  "_model_complexity": _model_complexity,
...
var real____em_js__display_fps = asm["___em_js__display_fps"]; asm["___em_js__display_fps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__display_fps.apply(null, arguments);
};

var real____em_js__main_ready = asm["___em_js__main_ready"]; asm["___em_js__main_ready"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__main_ready.apply(null, arguments);
};

var real____em_js__model_complexity = asm["___em_js__model_complexity"]; asm["___em_js__model_complexity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real____em_js__model_complexity.apply(null, arguments);
};
...
var real__load_model = asm["_load_model"]; asm["_load_model"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__load_model.apply(null, arguments);
};
...
var ___em_js__display_fps = Module["___em_js__display_fps"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__display_fps"].apply(null, arguments) };
var ___em_js__main_ready = Module["___em_js__main_ready"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__main_ready"].apply(null, arguments) };
var ___em_js__model_complexity = Module["___em_js__model_complexity"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["___em_js__model_complexity"].apply(null, arguments) };
